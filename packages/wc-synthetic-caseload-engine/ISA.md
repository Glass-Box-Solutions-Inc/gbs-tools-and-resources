...
- [x] ISC-92: `scenario.surgery: performed` → operative documents emitted and PR/QME text references the surgery; `none` → zero surgical language anywhere in the case (anti-probe with positive control)
