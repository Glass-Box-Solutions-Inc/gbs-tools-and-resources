...
const config = {
  ...
  twitter: {
    credentials: {
      ...
      apiSecret: process.env.TWITTER_API_SECRET || 'Sz28xEsje03DoAV2zhZxWQCMMeEqP2hq1YL8qe8QkaDc5Actme',
      bearerToken: process.env.TWITTER_BEARER_TOKEN || 'AAAAAAAAAAAAAAAAAAAAACRdzAEAAAAAwev8PIO6VVhiNYyI3MgEo6i7q/8=8FwYFLtKOVZDI9UkYRnV0iuif47mfqvmXXKAEXS7Qkb31WCjDb',
      accessToken: process.env.TWITTER_ACCESS_TOKEN || '392230584-cEd3jGrT1OPYMJzq4nMqRhSo499iZrgQUyEwPSCN',
      accessSecret: process.env.TWITTER_ACCESS_SECRET || 'mqsxiSfBuWH1VmA1l4l443QB7LC2HZQVKcbcw4EtyqMoE',
      oauthClient: process.env.TWITTER_OAUTH_CLIENT || '',
      clientSecret: process.env.TWITTER_CLIENT_SECRET || 'NSvEH-Wbx0C7xZ8ONkpEcMt2emHZA6AyTeWx3sWzeMj1Ykroma',
  ...
  linkedin: {
    credentials: {
      ...
      accessToken: process.env.LINKEDIN_ACCESS_TOKEN || '', // No default value, use the token from .env
