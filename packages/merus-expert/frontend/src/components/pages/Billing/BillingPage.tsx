...
import { Receipt, Key } from 'lucide-react'
import { Card, Button } from '../../ui'
import { BillTimeForm } from './BillTimeForm'
import { AddCostForm } from './AddCostForm'
import { BillingCodesTable } from './BillingCodesTable'
      ...
      <div className="page-container">
        <Card className="max-w-md mx-auto mt-12 text-center">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Configure your MerusCase API key to use billing features.
          </p>
    ...
    <div className="page-container">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="page-subtitle">Bill time and add costs to cases</p>
        </div>
      </div>
