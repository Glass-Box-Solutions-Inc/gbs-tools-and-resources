...
**Agent memory system with biomimetic data structures — retain, recall, reflect.**
...
| Service | Port | URL |
|---------|------|-----|
| Frontend | 4600 | http://localhost:4600 |
| API | 4601 | http://localhost:4601 |
| PostgreSQL | 5438 | localhost:5438 |

> Port block: 4600–4699 (reserved exclusively for this project)
> Full registry: `adjudica-documentation/engineering/GBS_PORT_AND_URL_REGISTRY.md`
